          ...
          <div className="lg:pl-8 text-center lg:text-left">
            ...
            <ul className="space-y-4">
              {['Home', 'About', 'Products', 'Projects'].map((item) => (
                <li key={item}>
                  <Link to="/" className="text-[#8f0f07] hover:translate-x-2 transition-all duration-300 flex items-center justify-center lg:justify-start gap-2 group text-sm font-medium">
